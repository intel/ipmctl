...
#define FORMAT_STR_WITH_PARENTHESIS             L" (%s)"
...
#define FORMAT_STR_COLON_SPACE_STR              L"%s: %s"
#define FORMAT_STR_COLON_SPACE_HEX              L"%ls: 0x%x"
...
#define FORMAT_POINTER                          L"0x%x"
#else // OS_BUILD
#define FORMAT_NL                               L"\n"
#define FORMAT_STR                              L"%ls"
#define FORMAT_STR_WITH_PARENTHESIS             L" (%ls)"
...
#define FORMAT_STR_COLON_SPACE_STR              L"%ls: %ls"
#define FORMAT_STR_COLON_SPACE_HEX              L"%ls: 0x%x"
