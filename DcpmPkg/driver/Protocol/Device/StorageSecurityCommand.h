...
#ifndef _STORAGESECURITYCOMMAND_H_
#define _STORAGESECURITYCOMMAND_H_
...
extern EFI_GUID gNvmDimmStorageSecurityCommandProtocolGuid;

#endif /* _STORAGESECURITYCOMMAND_H_ */
