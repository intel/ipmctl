...
#define DIE_SPARING_ENABLED_STR     L"DieSparingEnabled"
#define DIE_SPARING_LEVEL_STR       L"DieSparingLevel"
#define DIE_SPARING_CAPABLE_STR     L"DieSparingCapable"
#define DIE_SPARES_AVAILABLE_STR    L"DieSparesAvailable"
