...
/**
  Cache line size in bytes. Used by all of the platforms supporting Intel DCPMEM modules
**/
...
#define TEMPERATURE_THRESHOLD_MIN 20
#define TEMPERATURE_CONTROLLER_THRESHOLD_MAX 105
#define TEMPERATURE_MEDIA_THRESHOLD_MAX 85
#define TEMPERATURE_MEDIA_THRESHOLD_DEFAULT 84
#define TEMPERATURE_CONTROLLER_THRESHOLD_DEFAULT 104
