  ...
  )
{
  ...
  case NVM_ERR_DIMM_SKU_PACKAGE_SPARING_MISMATCH:
    return HiiGetString(HiiHandle, STRING_TOKEN(STR_DCPMM_STATUS_ERR_DIMM_SKU_PACKAGE_SPARING_MISMATCH), NULL);
  ...
  case NVM_ERR_FW_GET_FA_UNSUPPORTED:
    return HiiGetString(HiiHandle, STRING_TOKEN(STR_DCPMM_STATUS_ERR_FW_GET_FA_UNSUPPORTED), NULL);

  case NVM_ERR_FW_GET_FA_DATA_FAILED:
    return HiiGetString(HiiHandle, STRING_TOKEN(STR_DCPMM_STATUS_ERR_FW_GET_FA_DATA_FAILED), NULL);
  ...
  case NVM_ERR_INVALIDPARAMETER:
    return HiiGetString(HiiHandle, STRING_TOKEN(STR_DCPMM_STATUS_ERR_INVALIDPARAMETER), NULL);
