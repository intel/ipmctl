...
InitErrorAndWarningNvmStatusCodes()
{
  ...
  SetNvmStatus(&gAllErrorNvmStatuses, NVM_ERR_DIMM_SKU_DIE_SPARING_MISMATCH);
  ...
  )
{
  ...
  case NVM_ERR_DIMM_SKU_DIE_SPARING_MISMATCH:
    return HiiGetString(HiiHandle, STRING_TOKEN(STR_NVMDIMM_STATUS_ERR_DIMM_SKU_DIE_SPARING_MISMATCH), NULL);
