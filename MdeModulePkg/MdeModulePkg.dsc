...
[Components]
  !ifndef HII_ONLY
    src/driver/NvmDimmDriver.inf {
    <PcdsFixedAtBuild>
      gEfiMdePkgTokenSpaceGuid.PcdDebugPropertyMask|0xff
      gEfiMdePkgTokenSpaceGuid.PcdDebugPrintErrorLevel|0x80000000 #error
      #gEfiMdePkgTokenSpaceGuid.PcdDebugPrintErrorLevel|0x80400042 #error + verbose + debug + warn
    }
  !endif
  !ifndef DRIVER_ONLY
    src/hii/NvmDimmHii.inf {
    <PcdsFixedAtBuild>
      gEfiMdePkgTokenSpaceGuid.PcdDebugPropertyMask|0xff
      gEfiMdePkgTokenSpaceGuid.PcdDebugPrintErrorLevel|0x80000000 #error
      #gEfiMdePkgTokenSpaceGuid.PcdDebugPrintErrorLevel|0x80400042 #error + verbose + debug + warn
