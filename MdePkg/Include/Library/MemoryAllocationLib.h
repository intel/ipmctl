...
#define TRACE_ENTRY_FROM_NODE(a) BASE_CR(a, TraceEntry, TraceEntryNode)
#define POINTER_ENTRY_FROM_NODE(a) BASE_CR(a, PointerEntry, PointerEntryNode)
#define FILE_PATH_MAXLEN 512
#define FUNCTION_PATH_MAXLEN 512
#define FILE_NAME_MAXLEN 64
#define FUNCTION_NAME_MAXLEN 64

typedef struct PointerEntry {
  LIST_ENTRY PointerEntryNode;
  VOID *pPointer;
  CHAR16 File[FILE_PATH_MAXLEN];
  CHAR16 Function[FUNCTION_PATH_MAXLEN];
} PointerEntry;

typedef struct TraceEntry {
  LIST_ENTRY TraceEntryNode;
  CHAR16 File[FILE_NAME_MAXLEN];
  CHAR16 Function[FUNCTION_NAME_MAXLEN];
} TraceEntry;

extern BOOLEAN gMemoryTracingEnabled;
extern LIST_ENTRY *gpPointerList;
extern LIST_ENTRY *gpTraceList;
