...
TABLE_ITEM  MemoryOperatingModeCapabilityTable[] = {
  {
    1,
    L" Other"
  },
...
/**
Display Memory OperatingModeCapability (Type 17) .
...
VOID
DisplayMemoryOperatingModeCapability(
  IN UINT16  Para,
  IN UINT8   Option
)
{
  ShellPrintHiiEx(-1, -1, NULL, STRING_TOKEN(STR_SMBIOSVIEW_QUERYTABLE_MEM_OPERATING_MODE_CAPABILITY), gShellDebug1HiiHandle);
  PRINT_INFO_OPTION(Para, Option);
  PRINT_BITS_INFO(MemoryOperatingModeCapabilityTable, Para);
}
