...
/**
  ...
  This function returns true for OS builds. Debug print level should be determined at a different layer.
...
)
{
  ...
  static const int nBuffSize = MAX_STRING_LENGTH;
  static wchar_t evalBuff[MAX_STRING_LENGTH];
...
/**
  Retrieve the device path protocol from a handle.
