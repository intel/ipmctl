...
#define SYSTEM_EVENT_CAT_MGMT_NUMB_1        1
#define SYSTEM_EVENT_CAT_MGMT_NUMB_2        2
#define SYSTEM_EVENT_CAT_MGMT_NUMB_3        3
#define SYSTEM_EVENT_CAT_MGMT_NUMB_4        4
#define SYSTEM_EVENT_CAT_MGMT_NUMB_5        5
#define SYSTEM_EVENT_CAT_MGMT_NUMB_6        6
...
#define SYSTEM_EVENT_CAT_MGMT_NUMB_11       11
